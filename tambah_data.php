        ...
        <div class="container mt-5 justify-content-center col-md-4  col-lg-3  justify-content-between card">
            <div class="mb-3 ">
                <form action="proses_tambah_data.php" method="post">
                    ...
                    <input type="file" name="gambar_barang" id="gambar_barang" ><br>
                    ...
                    <input type="number" class="form-control" id="jumlah_barang" name="jumlah_barang" required><br>
                    <br>
                    
                    <button type="submit" value="sumbit" class="btn btn-primary">Submit</button>
